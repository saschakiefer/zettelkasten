...
@QuarkusTest
@TestProfile(TemplateManagementFileAdapterInconsistencyTest.TestProfile.class)
class TemplateManagementFileAdapterInconsistencyTest {
    ...
    public void retrieveTemplate_WithInvalidFileName_ReturnsEmptyTemplate() {
        ...
        assertEquals("", out.getTemplate());
    }

    public static class TestProfile implements QuarkusTestProfile {
        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of("slipbox.template", "./src/test/resources/slipbox/template/NotFound.md");
        }
    }
}